...
# georgia_mortality <- read_csv("path/to/georgia_mortality.csv")

# Load sociodemographic data
# sociodemographics <- read_csv("path/to/sociodemographics.csv")

# For this report, we assume the data is already loaded
